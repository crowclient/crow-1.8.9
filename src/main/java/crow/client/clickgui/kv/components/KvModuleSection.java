...
import crow.client.clickgui.kv.KvSection;
...
public class KvModuleSection extends KvSection {
    ...
    private List<KvComponent> currentComponents = new ArrayList<KvComponent>();
    private List<KvComponent> allCurrentComponents = new ArrayList<KvComponent>();
