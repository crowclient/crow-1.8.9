...
public class SpaciousCategoryTab {
    ...
    public void draw(int mouseX, int mouseY, CompactPalette palette) {
        ...
        //
        // Both fills run well below opaque so the blurred world behind the GUI
        // reads through them — that backdrop blur is already on screen from
        // GuiModule.applyBackdropBlurShader, so the glass costs nothing extra.
