...
public class SpaciousGui extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partial) {
        ...
        // Panel fills are translucent, so the blurred world behind them IS the
        // glass. Without this the tabs show the raw sharp world through
        // themselves. onGuiClosed already stops the shader.
