...
public class Config {
    public static final String LEGACY_EXTENSION = ".bplus";
    public static final String CROW_EXTENSION = ".crow";
    ...
    public String getName() {
        ...
        if (name.endsWith(CROW_EXTENSION)) {
            return name.substring(0, name.length() - CROW_EXTENSION.length());
        }
