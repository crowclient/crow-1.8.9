...
public class RightClicker extends Module {
    ...
    public void onRender2D(Render2DEvent e) {
        ...
        if (clickStyle.getMode() == ClickStyle.Crow) {
            crowClick();
    ...
    private void skidClick() {
        ...
        double periodSec = 1.0 / Utils.Client.sampleClickCps(rightCPS, this.rand);
        double rightHoldLength = periodSec * (0.28D + 0.62D * this.rand.nextDouble());
        ...
        if (Mouse.isButtonDown(1) || rightDown) {
            ...
            if (System.currentTimeMillis() - lastClick > periodSec * 1000) {
    ...
    public boolean rightClickAllowed() {
        ...
        if (preferFastPlace.isToggled()) {
            Module fastplace = Crow.moduleManager.getModuleByClazz(FastPlace.class);
    ...
    public void genRightTimings() {
        double clickSpeed = Utils.Client.sampleClickCps(rightCPS, this.rand);
