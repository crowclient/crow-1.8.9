...
public class Statistics extends Module {
    ...
    public Statistics() {
        ...
        this.registerSetting(showLogo = new TickSetting("Logo", true));
        this.registerSetting(showWordmark = new TickSetting("Wordmark", true));
        this.registerSetting(showServer = new TickSetting("Server", true));
        this.registerSetting(showPing = new TickSetting("Ping", true));
        this.registerSetting(showFPS = new TickSetting("FPS", true));
        this.registerSetting(showPlaytime = new TickSetting("Session", false));
        this.registerSetting(showClock = new TickSetting("IRL time", false));
        this.registerSetting(showIrlDay = new TickSetting("IRL day", false));
        this.registerSetting(showKills = new TickSetting("Kills", false));
        this.registerSetting(showCoords = new TickSetting("Coords", false));
        this.registerSetting(showDirection = new TickSetting("Direction", false));
        this.registerSetting(showBiome = new TickSetting("Biome", false));
        this.registerSetting(showSpeed = new TickSetting("Speed", false));
        this.registerSetting(showDay = new TickSetting("MC day", false));
        ...
        this.registerSetting(orderSession   = new SliderSetting("Session order", 6, 1, 20, 1));
        ...
        this.registerSetting(orderCoords    = new SliderSetting("Coords order", 10, 1, 20, 1));
        this.registerSetting(orderDirection = new SliderSetting("Dir order", 11, 1, 20, 1));
