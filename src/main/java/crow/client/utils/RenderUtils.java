...
public class RenderUtils {
    ...
    private static boolean drawSdfShape(float x, float y, float x1, float y1,
        ...
        GL11.glTexCoord2f(0.0F, 0.0F); GL11.glVertex2f(x  - padLeft,  y  - padTop);
        GL11.glTexCoord2f(0.0F, 0.0F); GL11.glVertex2f(x  - padLeft,  y1 + padBottom);
        GL11.glTexCoord2f(1.0F, 0.0F); GL11.glVertex2f(x1 + padRight, y1 + padBottom);
        GL11.glTexCoord2f(1.0F, 0.0F); GL11.glVertex2f(x1 + padRight, y  - padTop);
        GL11.glEnd();
     ...
     *
     * <p>One shape rather than a flat fill plus a strip-tessellated gradient
     * on top: the strip path insets its corners geometrically, so it
     * stairsteps against an SDF shape underneath. Pass the same colour twice
     * for a flat fill.
     */
